    ...
    if self.Locked ~= true then
      if self.tier > 0 then
          ...
          if self.color == 1 then
            ...
            --  if randomNumber == 1 and key.showKey == false and key.shownKey ~= false then
            --    key.showKey = true
            --  end
      ...
      self.psystem:setColors(
          paletteColors[self.color == 1 and 1 or self.color + 1].r,
          paletteColors[self.color == 1 and 1 or self.color + 1].g,
          paletteColors[self.color == 1 and 1 or self.color + 1].b,
          55 * (self.tier + 1),
          paletteColors[self.color == 1 and 1 or self.color + 1].r,
          paletteColors[self.color == 1 and 1 or self.color + 1].g,
          paletteColors[self.color == 1 and 1 or self.color + 1].b,
