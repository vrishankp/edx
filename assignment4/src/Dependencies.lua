...
gTextures = {
    ...
    ['only-flags'] = love.graphics.newImage('graphics/only-flags.png'),
...
gFrames = {
    ...
    ['flags'] = GenerateQuads(gTextures['flags'], 16, 48), --flag pole
    ['only-flags'] = GenerateQuads(gTextures['only-flags'], 16, 16), --flag
